...
enum ToolDefinitions {
    static let all: [AgentTool] = [
        ...
        AgentTool(
            ...
            inputSchema: objectSchema(
                properties: [
                    "prompt": ["type": "string", "description": "Required for text-driven models. TTS uses it as spoken text. Music uses it as the description — for ACE-Step write a descriptive prose caption (genre, instruments, vocal character, production texture, mood), ending with an explicit BPM; not tags. Omit for Voice Cleanup and Dubbing."],
                    "name": ["type": "string", "description": "Display name for the asset in the media library. Defaults to first 30 chars of prompt."],
        ...
        AgentTool(
            ...
            inputSchema: objectSchema(
                properties: [
                    ...
                    "prompt": ["type": "string", "description": "Prose caption for the new audio — genre, instruments, vocal character, production texture, mood, ending with an explicit BPM; not tags. Required for edit; optional for extend/repaint."],
