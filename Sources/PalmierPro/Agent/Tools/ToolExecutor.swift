...
final class ToolExecutor {
    ...
    private func run(_ tool: ToolName, _ editor: EditorViewModel, _ args: [String: Any]) async throws -> ToolResult {
        ...
        case .editImage:     return try editImageTool(editor, args)
        case .regionEdit:    return try regionEdit(editor, args)
        case .removeBackground: return try removeBackground(editor, args)
        case .outpaintImage: return try outpaintImage(editor, args)
